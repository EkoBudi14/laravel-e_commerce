                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-2" data-aos="zoom-in">
                            <a href="/cart.html" class="btn btn-success px-4 text-white btn btn-block mb-3">
                                Add To Cart
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            ...
                            <p>
                                ...
                                of the iconic Air Max 90.
                                Brand-new Nike Air cushioning underfoot adds unparalleled comfort while transparent mesh and
                                vibrantly coloured
                                details on the upper are blended with timeless OG features for an edgy, modernised look.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="/images/user-pic-1.png" class="mr-3 rounded-circle" alt="">
                                ...
                                <li class="media">
                                    <img src="/images/user-pic-2.png" class="mr-3 rounded-circle" alt="">
                                    <div class="media-body">
                                        <h5 class="mt-2 mb-1">
                                            Melinda
                                        </h5>
                                ...
                                <li class="media">
                                    <img src="/images/user-pic-3.png" class="mr-3 rounded-circle" alt="">
                                    <div class="media-body">
                                        <h5 class="mt-2 mb-1">
                                            Olive
                                        </h5>
