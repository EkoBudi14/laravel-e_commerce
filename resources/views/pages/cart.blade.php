        ...
        <section class="store-cart">
            <div class="container">
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-12 table-responsive">
                        <table class="table table-borderless table-cart">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width : 20%"><img src="/images/image-product-cart-1.jpg" alt=""
                                            class="cart-image"></td>
                                    <td style="width : 35%">
                                ...
                                <tr>
                                    <td style="width : 20%"><img src="/images/image-product-cart-2.jpg" alt=""
                                            class="cart-image"></td>
                                    <td style="width : 35%">
                                        <div class="product-title">Sneaker</div>
                                        <div class="product-subtitle">By Djaja</div>
                                    </td>
                                    <td style="width : 35%">
                                ...
                                <tr>
                                    <td style="width : 20%"><img src="/images/image-product-cart-3.jpg" alt=""
                                            class="cart-image"></td>
                                    <td style="width : 35%">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="col-12">
                        <h2 class="mb-4">Payments Information</h2>
                    </div>
                </div>
